...
const HeroSection = () => {
    ...
    />
            ...
            Located in Columbus, Ohio.
                 ...
                 <div>
                    <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 mb-2 bg-gradient-to-br from-teal-800 via-teal-600 to-red-600 text-white hover:text-red-600">Hire Me</button>
                    <button className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-teal-800 via-teal-600 to-red-600 text:white hover:text-red-600 mt-3"><span className="block bg-black rounded-full px-5 py-2">Download CV</span></button>
                 </div>
            </div>
